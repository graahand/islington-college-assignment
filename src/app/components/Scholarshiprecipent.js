...
const ScholarshipRecipient = () => {
  return (
    ...
    <div class="flex bg-gray-50 min-h-screen items-center mt-[-6cm] justify-center ">
      ...
      <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
        ...
        Monil Adhikari
          ...
          <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
            <p class="mb-3 text-sm text-center text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
